...
var drawStaticChart = parameterfy(function(
  main_indicator,
  disaggregate_by,
  container,
  chart_type
  ...
  for (var a in static_data[filter.year][main_indicator]["answer"][
    ...
    if (a != "num_children") {
      ...
      if (window.language == "en") {
        serie["y"] = parseFloat(
          static_data[filter.year][main_indicator]["answer"][
            window.language
          ][0][a]["Percentage"]
        );
      }
  ...
  for (var element in series_data) {
    ...
    for (var json in static_data[filter.year][main_indicator]["answer"][
      window.language
    ][0]) {
      if (json != "num_children") {
        if (json == series_data[element]["name"]) {
          if (disaggregate_by == "Gender") {
            var percentage_men = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Men"]
            );
            var percentage_women = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Women"]
            );
          ...
          if (disaggregate_by == "Gjinia") {
            var percentage_men = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Burra"]
            );
            var percentage_women = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Gra"]
            );
            drilldown_serie["data"].push(
              ["Burra", percentage_men],
              ["Gra", percentage_women]
            );
          }
          if (disaggregate_by == "Pol") {
            var percentage_men = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Muškarci"]
            );
            var percentage_women = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Žene"]
            );
            drilldown_serie["data"].push(
              ["Muškarci", percentage_men],
              ["Žene", percentage_women]
            );
          }

          if (disaggregate_by == "Age") {
            var percentage_first = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Age 18-25"]
            );
            var percentage_second = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Age 26-35"]
            );
            var percentage_third = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Age 36-45"]
            );
            var percentage_fourth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Age 46-55"]
            );
            var percentage_fifth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Age 56-65"]
            );
            var percentage_sixth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Age 66+"]
            );
          ...
          if (disaggregate_by == "Mosha") {
            var percentage_first = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Mosha 18-25"]
            );
            var percentage_second = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Mosha 26-35"]
            );
            var percentage_third = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Mosha 36-45"]
            );
            var percentage_fourth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Mosha 46-55"]
            );
            var percentage_fifth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Mosha 56-65"]
            );
            var percentage_sixth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Mosha 66+"]
            );
          ...
          if (disaggregate_by == "Starost") {
            var percentage_first = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Godina 18-25"]
            );
            var percentage_second = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Godina 26-35"]
            );
            var percentage_third = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Godina 36-45"]
            );
            var percentage_fourth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Godina 46-55"]
            );
            var percentage_fifth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Godina 56-65"]
            );
            var percentage_sixth = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Godina 66+"]
            );
          ...
          if (disaggregate_by == "Ethnicity") {
            var percentage_first = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Albanian"]
            );
            var percentage_second = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Serb"]
            );
            var percentage_third = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Other"]
            );
          ...
          if (disaggregate_by == "Etnička pripadnost") {
            var percentage_first = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Kosovski albanci"]
            );
            var percentage_second = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Kosovski srbi"]
            );
            var percentage_third = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Ostali kosovci"]
            );
          ...
          if (disaggregate_by == "Membership") {
            var percentage_first = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json]["Member/volunteer in one or more CSOs"]
            );
            var percentage_second = parseFloat(
              static_data[filter.year][main_indicator]["answer"][
                window.language
              ][disaggregate_by][json][
          ...
          if (
            ...
            if (main_indicator == "5N4") {
              var percentage_first = parseFloat(
                static_data[filter.year][main_indicator]["answer"][
                  window.language
                ][disaggregate_by][json]["Član/volunter jedne ili više OCD-a"]
              );
              var percentage_second = parseFloat(
                static_data[filter.year][main_indicator]["answer"][
                  window.language
              ...
              var percentage_third = parseFloat(
                static_data[filter.year][main_indicator]["answer"][
                  window.language
                ][disaggregate_by][json]["Nema odgovora"]
              );
              drilldown_serie["data"].push(
  ...
  Highcharts.setOptions({
    lang: {
      drillUpText: translation_data[filter.year]["Back"][window.language]
    }
  });
...
var drawChart = parameterfy(function(
  container,
  chart_type,
  data,
  double_questions,
  ...
  if (static_question != undefined) {
    title = getChartTitle(
      static_question.replace("q", ""),
      translation_data[filter.year][static_question][window.language]
    );
  } else {
    var question_title = e.options[e.selectedIndex].text;
    title = getChartTitle(question_id.replace("q", ""), question_title);
    ...
    if (question_id.length == 3) {
      if (question_id.charAt(0) == "1") {
        return (
          chart_title +
          " - <i>" +
          translation_data[filter.year]["CSO"][window.language] +
          "</i>"
        );
        ...
        return (
          chart_title +
          " - <i>" +
          translation_data[filter.year]["Development-Partners"][
            window.language
          ] +
          "</i>"
        );
        ...
        return (
          chart_title +
          " - <i>" +
          translation_data[filter.year]["CSO-Network"][window.language] +
          "</i>"
        );
        ...
        return (
          chart_title +
          " - <i>" +
          translation_data[filter.year]["External"][window.language] +
          "</i>"
        );
        ...
        return (
          chart_title +
          " - <i>" +
          translation_data[filter.year]["UNDP"][window.language] +
          "</i>"
        );
      }
...
function drawMultipleSeriesChart(
  chart_container,
  chart_type,
  title,
  categories,
  ...
  $("#" + chart_container).highcharts({
    ...
    tooltip: {
      backgroundColor: "rgba(255,255,255,1)",
      headerFormat:
        '<span style="font-size:12px; text-align: center;"><b>{point.key}</b></span><table>',
      pointFormat:
